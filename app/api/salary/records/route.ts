...
export async function GET(request: Request) {
  try {
    ...
    const { data, error } = await supabase
      .from('salary_records')
      .select('id,year,cl,division,contract_salary_man,base_up_raise_rate,performance_raise_rate,raise_rate,promotion_yn,promotion_from_cl,promotion_to_cl,promotion_raise_rate,ds_ps_rate,business_performance_bonus_man,withholding_income_man,withholding_pi_rate,withholding_ps_man,withholding_pi_man,memo,created_at,updated_at')
